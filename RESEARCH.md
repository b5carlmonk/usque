...
> **Personal note:** I confirmed this flow by also capturing traffic from the iOS app using a jailbroken device — the same PATCH request is sent there as well, so this appears to be consistent across platforms.
